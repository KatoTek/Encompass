...
namespace Encompass.Concepts.DateRanges.Extensions
{
    ...
    public static class DateRangeExtensions
    {
        ...
        public static int BusinessDays(this IDateRange dateRange, params DateTime[] holidays) => dateRange == null
                                                                                                     ? 0
                                                                                                     : Date.BusinessDays(dateRange.Start, dateRange.End, holidays);

        /// <inheritdoc cref="Date.BusinessHours(DateTime, DateTime, string, DateTime[])" />
        /// <param name="dateRange">The date range to check</param>
        public static int BusinessHours(this IDateRange dateRange, string timeZoneId, params DateTime[] holidays) => dateRange == null
                                                                                                                         ? 0
                                                                                                                         : Date.BusinessHours(dateRange.Start,
                                                                                                                                              dateRange.End,
                                                                                                                                              timeZoneId,
                                                                                                                                              holidays);
                                        ...
                                        params DateTime[] holidays)
        {
            return dateRange == null
                       ? 0
                       : Date.BusinessHours(dateRange.Start, dateRange.End, timeZoneId, startOfDayHour, startOfDayMinute, endOfDayHour, endOfDayMinute, holidays);
        }
        ...
        public static int BusinessHours(this IDateRange dateRange,
                                        ...
                                        int breakEndHour,
                                        int breakEndMin,
                                        params DateTime[] holidays) => dateRange == null
                                                                           ? 0
                                                                           : Date.BusinessHours(dateRange.Start,
                                                                                                dateRange.End,
                                                                                                timeZoneId,
        ...
        public static IEnumerable<DateTime> Dates(this IDateRange dateRange) => dateRange == null
                                                                                    ? null
                                                                                    : Enumerable.Range(0, dateRange.Days())
                                                                                                .Select(index => dateRange.Start.WithoutTime()
                                                                                                                          .AddDays(index));
        ...
        public static int Days(this IDateRange dateRange) => dateRange == null
                                                                 ? 0
                                                                 : Date.Days(dateRange.Start, dateRange.End);
        ...
        /// <returns>
        ///     A date range where the end date is determined by adding the specified number of business
        ///     <paramref name="days" /> to the original end date
        /// </returns>
        ...
        /// <returns>
        ///     A date range where the end date is determined by adding the specified number of <paramref name="days" /> to
        ...
        public static int Months(this IDateRange dateRange)
        {
            ...
            return dateRange == null
                       ? 0
                       : new DateDifference(dateRange).Months;
        }
        ...
        /// <param name="holidays">Holidays dates to exclude when determining business days</param>
        /// <returns>
        ///     A date range where the start date is determined by subtracting the specified number of business
        ///     <paramref name="days" /> from the original start date
        /// </returns>
        ...
        /// <returns>
        ///     A date range where the start date is determined by subtracting the specified number of
        ///     <paramref name="days" /> from the original start date
        /// </returns>
        ...
        /// <inheritdoc
        ///     cref="TryBusinessHours(IOpenEndedDateRange, string, int, int, int, int, int, int, int, int, out int, DateTime[])" />
                                            ...
                                            params DateTime[] holidays)
        {
            ...
            try
            {
                businessHours = Date.BusinessHours(dateRange.Start,
                                                   dateRange.End.Value,
                                                   timeZoneId,
                                                   startOfDayHour,
                                                   startOfDayMinute,
        ...
        ///     The <paramref name="end" /> date must be greater than the <paramref name="start" />
        ///     date
        /// </exception>
