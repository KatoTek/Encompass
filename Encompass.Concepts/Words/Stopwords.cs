...
{
    /// <summary>
    ///     Provides a list of stop words and ways to work with them. Stop words are words that are useful to filter out when
    ///     performing text searches based on individual words.
    /// </summary>
    public static class Stopwords
    {
        ...
        ///     The separators to use to split the string. The default value is null, which uses a space as
        ///     the separator when splitting the string
        /// </param>
        ...
        public static IQueryable<string> FilterOut(IEnumerable<string> terms) => terms?.Distinct()
                                                                                       .Except(Get())
                                                                                       .AsQueryable() ?? new string[0].AsQueryable();
