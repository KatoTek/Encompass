...
namespace Encompass.Simple.Extensions
{
    ...
    public static class NullablesExtensions
    {
        ...
        /// <param name="source"><inheritdoc cref="Nullables{T}(Nullable{T}, Nullable{T})" select="/param[@name='a']/node()"/></param>
        /// <param name="other"><inheritdoc cref="Nullables{T}(Nullable{T}, Nullable{T})" select="/param[@name='b']/node()"/></param>
        ...
        /// <param name="source"><inheritdoc cref="Strings(string, string)" select="/param[@name='a']/node()"/></param>
        /// <param name="other"><inheritdoc cref="Strings(string, string)" select="/param[@name='b']/node()"/></param>
