...
namespace Encompass.Simple.Extensions
{
    ...
    public static class ObjectExtensions
    {
        ...
        /// <param name="source"><inheritdoc cref="PropertyExist(object, string)" select="/param[@name='obj']/node()"/></param>
        ...
        /// <param name="source"><inheritdoc cref="PropertyExist{T}(object, string, out T)" select="/param[@name='obj']/node()"/></param>
        ...
        /// <param name="source"><inheritdoc cref="NotNullThen{T}(T, Action{T})" select="/param[@name='obj']/node()"/></param>
        ...
        /// <param name="source"><inheritdoc cref="NotNullThenGet{T, TResult}(T, Func{T, TResult})" select="/param[@name='obj']/node()"/></param>
