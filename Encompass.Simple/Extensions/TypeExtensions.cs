...
namespace Encompass.Simple.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        /// <summary>
        ///     Gets an attribute of type <typeparamref name="T" /> property <paramref name="propertyName" /> from the supplied
        ///     <paramref name="source" /> type
        /// </summary>
        /// <typeparam name="T">The type of the attribute to get</typeparam>
        /// <param name="source">
        ///     The type of the object that contains the <paramref name="propertyName" /> for which to get the
        ///     attribute
        /// </param>
        ...
        public static T GetPropertyAttribute<T>(this Type source, string propertyName) where T : Attribute
        {
