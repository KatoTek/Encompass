...
namespace Encompass.Simple
{
    ...
    public static class Compare
    {
        ...
        /// <returns>
        ///     A 32-bit signed integer that indicates whether <paramref name="a" /> precedes,
        ...
        ///     Greater than zero if <paramref name="a" /> follows <paramref name="b" /> or <paramref name="b" /> is null
        /// </returns>
