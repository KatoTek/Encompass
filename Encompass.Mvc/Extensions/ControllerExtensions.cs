...
namespace Encompass.Mvc.Extensions
{
    ...
    public static class ControllerExtensions
    {
        ...
        /// <inheritdoc cref="JsonCamelCase(Controller, object, Formatting, string, Encoding, JsonRequestBehavior)" />
        public static JsonCamelCaseResult JsonCamelCase(this Controller controller, object data, Formatting formatting)
            => controller.JsonCamelCase(data, formatting, null, null, DenyGet);

        /// <inheritdoc cref="JsonCamelCase(Controller, object, Formatting, string, Encoding, JsonRequestBehavior)" />
        public static JsonCamelCaseResult JsonCamelCase(this Controller controller, object data, string contentType)
            => controller.JsonCamelCase(data, None, contentType, null, DenyGet);
        ...
        /// <inheritdoc cref="JsonCamelCase(Controller, object, Formatting, string, Encoding, JsonRequestBehavior)" />
        public static JsonCamelCaseResult JsonCamelCase(this Controller controller, object data, JsonRequestBehavior behavior)
            => controller.JsonCamelCase(data, None, null, null, behavior);

        /// <inheritdoc cref="JsonCamelCase(Controller, object, Formatting, string, Encoding, JsonRequestBehavior)" />
        public static JsonCamelCaseResult JsonCamelCase(this Controller controller, object data, string contentType, JsonRequestBehavior behavior)
            => controller.JsonCamelCase(data, None, contentType, null, behavior);
        ...
        public static JsonCamelCaseResult JsonCamelCase(this Controller controller,
                                                        object data,
        ...
        /// <inheritdoc cref="JsonCamelCase(Controller, object, Formatting, string, Encoding, JsonRequestBehavior)" />
        public static JsonCamelCaseResult JsonCamelCase(this Controller controller, object data, Formatting formatting, string contentType)
            => controller.JsonCamelCase(data, formatting, contentType, null, DenyGet);
        ...
        /// <inheritdoc cref="JsonCamelCase(Controller, object, Formatting, string, Encoding, JsonRequestBehavior)" />
        public static JsonCamelCaseResult JsonCamelCase(this Controller controller, object data, Formatting formatting, JsonRequestBehavior behavior)
            => controller.JsonCamelCase(data, formatting, null, null, behavior);
        ...
        /// <inheritdoc cref="JsonData(Controller, object, string, Encoding, JsonRequestBehavior)" />
        public static JsonResult JsonData(this Controller controller, object data, string contentType, Encoding contentEncoding)
            => controller.JsonData(data, contentType, contentEncoding, DenyGet);
        ...
        /// <inheritdoc cref="JsonData(Controller, object, string, Encoding, JsonRequestBehavior)" />
        public static JsonResult JsonData(this Controller controller, object data, string contentType, JsonRequestBehavior behavior)
            => controller.JsonData(data, contentType, null, behavior);

        /// <summary>
        ///     Serializes an object into JSON and adds it to the <see cref="Encompass.Mvc.Models.JsonData" /> return type which is
        ///     then assigned to the Data property of the returned <see cref="JsonResult" />.
        /// </summary>
        /// <param name="controller">The controller.</param>
        /// <param name="data">The object to serialize.</param>
        /// <param name="contentType">The type of the content. Can be null.</param>
        ...
        /// <param name="behavior">Specifies whether HTTP GET requests from the client are allowed.</param>
        /// <returns>
        ///     A <see cref="JsonResult" /> containing the serialized <paramref name="data" /> object as a
        ///     <see cref="Encompass.Mvc.Models.JsonData" /> object. The <see cref="Encompass.Mvc.Models.JsonData" />.Errors
        ///     property
        ///     is populated with any ModelState errors from the <paramref name="controller." />
        /// </returns>
        ...
        /// <summary>
        ///     Converts the Data of a regular <see cref="JsonResult" /> to a <see cref="Encompass.Mvc.Models.JsonData" /> object
        ///     and setting the <paramref name="controller" />.ModelState errors as the
        ///     <see cref="Encompass.Mvc.Models.JsonData" />.Errors
        /// </summary>
        /// <param name="controller">The controller</param>
        /// <param name="jsonResult">The <see cref="JsonResult" /> to convert.</param>
        /// <returns>
        ///     A <see cref="JsonResult" /> using the provided <paramref name="jsonResult" /> and converting the Data to a
        ///     <see cref="Encompass.Mvc.Models.JsonData" /> object. The <see cref="Encompass.Mvc.Models.JsonData" />.Errors
        ///     property
        ///     is populated with any ModelState errors from the <paramref name="controller." />
        /// </returns>
        ...
        /// <summary>
        ///     Serializes the <paramref name="data" /> object into JSON and returns it as a <see cref="JsonResult" /> allowing for
        ///     the maximum possible length of JSON data. Intended to be used for large
        ...
        /// <summary>
        ///     Converts a <see cref="JsonResult" /> into another <see cref="JsonResult" /> with the maximum possible length of
        ///     JSON data.
        /// </summary>
        /// <param name="controller">The controller.</param>
        /// <param name="jsonResult">The <see cref="JsonResult" /> to convert.</param>
        ...
        /// <inheritdoc cref="JsonMax(Controller, object, string, Encoding, JsonRequestBehavior)" />
        public static JsonResult JsonMax(this Controller controller, object data, string contentType, Encoding contentEncoding)
            => controller.JsonMax(data, contentType, contentEncoding, DenyGet);

        /// <inheritdoc cref="JsonMax(Controller, object, string, Encoding, JsonRequestBehavior)" />
        public static JsonResult JsonMax(this Controller controller, object data, string contentType, JsonRequestBehavior behavior)
            => controller.JsonMax(data, contentType, null, behavior);
        ...
        public static JsonpResult Jsonp(this Controller controller, string callBackFunction, object data, string contentType)
            => controller.Jsonp(callBackFunction, data, contentType, null);

        /// <inheritdoc cref="Jsonp(Controller, string, object, string, Encoding)" />
        public static JsonpResult Jsonp(this Controller controller, string callBackFunction, object data, Encoding contentEncoding)
            => controller.Jsonp(callBackFunction, data, null, contentEncoding);

        /// <inheritdoc cref="Jsonp(Controller, string, object, string, Encoding)" />
        public static JsonpResult Jsonp(this Controller controller, object data, string contentType, Encoding contentEncoding)
            => controller.Jsonp(null, data, contentType, contentEncoding);
