...
{
    /// <summary>
    /// Represents a JSONP result which is a way to get data from another domain that bypasses CORS (Cross Origin Resource Sharing) rules.
    ...
    public class JsonpResult : ActionResult
    {
        ...
        public override void ExecuteResult(ControllerContext context)
        {
            ...
            response.ContentType = IsNullOrWhiteSpace(ContentType) ? DEFAULT_CONTENT_TYPE : ContentType;
