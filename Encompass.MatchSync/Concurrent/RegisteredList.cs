...
namespace Encompass.MatchSync.Concurrent
{
    ...
    public class RegisteredList<T> : List<T>
    {
        ...
        /// <summary>
        ///     Converts the elements in the current <see cref="RegisteredList{T}" /> to another type, and returns the list
        ///     containing the converted elements
        /// </summary>
        /// <typeparam name="TOutput">The type to convert to</typeparam>
        /// <param name="converter">
        ///     A <see cref="Converter{T, TOutput}" /> delegate that converts each element from one type to
        ///     another type
        /// </param>
